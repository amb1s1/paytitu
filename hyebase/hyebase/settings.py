...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'amb1s1@gmail.com'
EMAIL_HOST_PASSWORD = 'Snowman_1976'
EMAIL_USE_TLS = True
...
DATABASES = {
    'default': {
        ...
        'NAME': 'paytituv1',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '7k87d=@9w29+=y&7_jo)%v@+e*gb!mm5ftm^fmq%itl1tsg5v0'
